...
import { DataTablePagination } from "@/app/alerts/components/data-table/data-table-pagination";
import { DataTableToolbar } from "@/app/alerts/components/data-table/data-table-toolbar";

import { DndProvider, useDrag, useDrop } from "react-dnd";
import { HTML5Backend } from "react-dnd-html5-backend";
import { AlertSchema } from "./columns";
import {
  fetchAlerts,
  getTotalRowCount,
  getPageSize,
...
import { TableAIChat } from "./table-ai-chat";
...
DataTableProps<TData, TValue>) {
  ...
  //alerts data
  const [alerts, setAlerts] = React.useState<AlertSchema[]>([]);
  ...
  const fetchData = React.useCallback(
    async (options: {
      ...
      const totalRows = await getTotalRowCount(options.queryConditions);
